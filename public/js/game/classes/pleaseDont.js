class pleaseDontScene extends Phaser.Scene {
    ...
    update (time, delta) {
        ...
        if(this.player) {
            ...
            if (tile.properties.loadNewPart) {
                ...
                this.scene.start('pleaseDont', { player: this.player, coords: newMapKey, x: this.player.x, y: this.player.y, direction: this.player.movement.direction, connection: this.socket });
            }
